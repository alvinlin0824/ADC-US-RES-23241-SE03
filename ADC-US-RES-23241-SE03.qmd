...
#| eval: false
file_list <- dir_ls(gsub("\\\\", "/", r"(\\Wf00168p.oneabbott.com\DATA1\cdm\ADC-US-RES-23241\SE03\UploadData)"),recurse = T, regexp = "*[0-9][.]txt$|*freestyle[.]csv$|*[0-9][.]csv$") |> 
...
#| eval: false
file_list |>
         path_filter(regexp = ".*Yuwell.*[.]txt$",ignore.case = T) |> 
         set_names() |>
         ...
         bind_rows(
           file_list |>
            path_filter(regexp = ".*Yuwell.*[.]csv$",ignore.case = T) |>
           # dir_ls(regexp = "*[.]csv$") |>
