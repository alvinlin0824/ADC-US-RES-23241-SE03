...
sasr2 <- sa |> 
         ...
         mutate(`Application Date and Time` = ymd_hm(str_c(DUDTC02,DUTM01,sep = " ")),
...
yuwell <- yuwell |> 
            ...
            # Remove glucose readings with errorcode = 11 or 16 
            filter(!ErrorCode %in% c("11","16"))
```
...
Ap <- yuwell |> 
      ...
      # Remove Extreme 25 readings < 2.2 or > 25.0
...
#| label: Profile Test
#| eval: false
breakdown_condition_plot(Id = "1170006")
```
